...
function validateCity(city) {
  if (!city) {
    console.log(chalk.red(`请指定要查询的城市`))
    console.log(
      chalk.red(
  ...
  if (err.response) {
    ...
    switch (data.status_code) {
      ...
      case 'AP010006':
        ...
        break
      case 'AP010010':
        console.log(chalk.red(`找不到指定的城市，请更换其它城市名`))
        break
      default:
        console.log(chalk.red(data.status))
    }
  } else {
    console.log(chalk.red(`Please check your network connection.`))
  }
}
